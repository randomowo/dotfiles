...
static const char* fonts[] = { "Anonymous Pro Minus:size=14" };
...
static const char* lockcmd[] = { "i3lock", "-k", "-ne", "--blur=5", "--insidecolor=373445ee", "--ringcolor=555555ee",
    "--line-uses-inside", "--keyhlcolor=b8a6edff", "--bshlcolor=d23c3dff", "--separatorcolor=00000044",
    "--insidevercolor=373445ee", "--insidewrongcolor=373445ee", "--ringvercolor=557755ee", "--ringwrongcolor=775555ee",
    "--radius=90", "--veriftext=\"nice\"", "--wrongtext=\"WARN\"", "--noinputtext=\"lock\"", NULL };
